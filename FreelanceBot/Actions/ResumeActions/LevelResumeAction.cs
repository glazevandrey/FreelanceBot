...
{
    public class LevelResumeAction : IBaseAction
    {
        public async Task Start(Update update)
        {
            Program.stageService.SetStage(update.Message.From.Id, 12);
            ...
            using (var db = new UserContext())
            {
                ...
                {
                    resume.Description = update.Message.Text;
                    db.SaveChanges();
                }
            }
            ...
            await Program.botClient.SendTextMessageAsync(update.Message.From.Id, "Choose your specialisation level:", replyMarkup: rkm);
        }
    }
}
